...
const QuestionList = () => {
  ...
  const { run: addQuestion, loading: addQuestionLoading } = useRequest(
    async (params) => {
      await request('/api/admin/question/addQuestion', {
        method: 'post',
        data: params,
      });
    },
  ...
  const { run: updateQuestion, loading: updateQuestionLoading } = useRequest(
    async (params) => {
      await request('/api/admin/question/updateQuestion', {
        method: 'post',
        data: params,
      });
    },
  ...
  const { run: deleteQuestion, loading: deleteQuestionLoading } = useRequest(
    async (params) => {
      await request(`/api/admin/question/deleteQuestion?id=${params}`, {
        method: 'post',
      });
    },
    {
  ...
  const { run: batchDeleteQuestion, loading: batchDeleteLoading } = useRequest(
    async (params) => {
      await request('/api/admin/question/batchDelete', {
        method: 'post',
        data: params,
      });
    },
    ...
    <PageContainer title="问题列表">
      <ProTable
        ...
        request={async (params) => {
          const res = await request('/api/admin/question/listQuery', {
            method: 'post',
            data: {
              ...params,
            },
